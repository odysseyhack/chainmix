...
namespace CheckCheque
{
  ...
  {
    public static IInvoiceRepository InvoiceRepository => new IotaInvoiceRepository(IotaRepository);
    public static IKvkRepository KvkRepository => new InMemoryKvkRepository();

    public static InvoiceVerificator InvoiceVerificator => new InvoiceVerificator(InvoiceRepository, KvkRepository);
